...
list_pending_migrations() {
    ...
    if [[ "$context" == "global" ]]; then
        ...
        migrations_path="$HOME/Projects/$context/migrations"
    fi
...
list_all_migrations() {
    ...
    if [[ -d "$HOME/Projects/$PROFILE/migrations" ]]; then
        for migration_file in "$HOME/Projects/$PROFILE/migrations"/*.zsh(N); do
