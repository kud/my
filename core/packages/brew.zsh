...
brewinstall btop # Modern system monitor - https://github.com/aristocratos/btop
brewinstall bottom # Cross-platform system monitor - https://github.com/ClementTsang/bottom
...
brewinstall hyperfine # Command-line benchmarking tool - https://github.com/sharkdp/hyperfine
brewinstall procs # Modern replacement for ps - https://github.com/dalance/procs
brewinstall sd # Intuitive find & replace CLI - https://github.com/chmln/sd
brewinstall tokei # Count lines of code quickly - https://github.com/XAMPPRocky/tokei
...
################################################################################
# Copy custom fonts
cp ${SYNC_FOLDER}/Lib/fonts/Operator\ Mono/* ~/Library/Fonts &>/dev/null
cp ${SYNC_FOLDER}/Lib/fonts/Operator\ Mono\ Lig/* ~/Library/Fonts &>/dev/null

# Install Nerd Fonts and other fonts via Homebrew Cask
caskinstall font-symbols-only-nerd-font # Nerd Font symbols - https://github.com/ryanoasis/nerd-fonts
caskinstall font-3270-nerd-font
caskinstall font-arimo-nerd-font
caskinstall font-cascadia-code
caskinstall font-cascadia-mono
...
caskinstall font-hubot-sans
caskinstall font-inconsolata-nerd-font
caskinstall font-iosevka-nerd-font
caskinstall font-jetbrains-mono
caskinstall font-jetbrains-mono-nerd-font
caskinstall font-lekton-nerd-font
caskinstall font-mona-sans
...
caskinstall font-symbols-only-nerd-font
...
# Load profile-specific brew configurations
source $MY/profiles/$OS_PROFILE/core/packages/brew.zsh 2>/dev/null
