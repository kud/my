...
Display the items exactly in this format (adapt language to match the calling skill's language — French if called from my-daily-briefing, English otherwise):
...
| Invoke another skill      | Run `/my-pr-comments-triage`, `/my-github-triage`, etc. |
